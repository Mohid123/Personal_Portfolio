        ...
        <div className='flex flex-col lg:flex-row lg:justify-between'>
            <div className='w-full lg:w-1/2'>
                ...
                <p className='mt-4 text-lg font-semibold'>
                    I'm an experienced front end web developer, with my primary specialty being in crafting front end UI interfaces. I earned my bachelor's degree in Space Sciences in 2020. Over the past 5 years, I've honed my skills to specialize in crafting visually impactful frontends within the dynamic realm of web development.
                    <br></br>
                    <br></br>
